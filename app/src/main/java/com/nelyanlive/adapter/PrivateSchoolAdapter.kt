...
class PrivateSchoolAdapter(activity: FragmentActivity, internal var datalist: ArrayList<GetPrivate>) : RecyclerView.Adapter<PrivateSchoolAdapter.Vh>() {
    var a: Activity
    ...
    inner class Vh(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindMethod(publicSchoolList: GetPrivate) {
