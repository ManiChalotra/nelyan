...
import com.nelyanlive.adapter.PrivateSchoolAdapter
import com.nelyanlive.adapter.PublicSchoolAdapter
import com.nelyanlive.data.viewmodel.AppViewModel
import com.nelyanlive.db.DataStoragePreference
import com.nelyanlive.modals.homeSectorization.GetPrivate
import com.nelyanlive.modals.homeSectorization.GetPublic
import com.nelyanlive.modals.homeSectorization.HomeSectorizationResponse
...
class HomeSectorizationActivity : AppCompatActivity(), View.OnClickListener, CoroutineScope {
            ...
            if (response!!.isSuccessful && response.code() == 200) {
                if (response.body() != null) {
                    ...
                    if (sectorizationTYPE.equals("private")) {
                        ...
                        tv_school_type.text = getString(R.string.private_schools)
                        ...
                        tv_school_type.text = getString(R.string.public_schools)
    ...
    private fun setPublicSchoolAdator(publicSchoolDatalist: ArrayList<GetPublic>) {
        ...
        rv_home_sectorization!!.layoutManager = LinearLayoutManager(this)
        rv_home_sectorization!!.adapter = publicSchoolAdapter
    ...
    private fun setPrivateSchoolAdator(privateSchoolDatalist: ArrayList<GetPrivate>) {
        ...
        rv_home_sectorization!!.layoutManager = LinearLayoutManager(this)
        rv_home_sectorization!!.adapter = privateSchoolAdapter
    }
