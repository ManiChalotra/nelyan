...
interface JsonPlaceHolder {
    ...
    @FormUrlEncoded
    fun getHomeDataListing(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?, @Field("type") type: String?
    ): Call<JsonObject>

    @POST("forgot_password")
    @FormUrlEncoded
    fun get_ForgetPassword_Api(
        @Header("security_key") securityKey: String?,
        @Field("email") email: String?
    ): Call<JsonObject>
    ...
    @POST("addPost_fav")
    @FormUrlEncoded
    fun addFavouritePost(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") authKey: String?,
        @Field("postId") postId: String?, @Field("type") type: String?
    ): Call<JsonObject>
    ...
    @Multipart
    @POST("edit_profile")
    fun get_EditProfile_withImage_Api(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?,
        @Part("name") name: RequestBody?,
        @Part("city") city: RequestBody?,
    ...
    @Multipart
    @POST("edit_profile")
    fun get_EditProfile_withoutImage_Api(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?,
        @Part("name") name: RequestBody?,
        @Part("city") city: RequestBody?,
    ...
    @FormUrlEncoded
    fun get_Notificatuion_Enable_Api(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?,
    ...
    @GET("activityTpe")
    fun get_ActivityType_Api(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?
    ): Call<JsonObject>

    @GET("getChildcareActivity")
    fun getChildCareType(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?
    ): Call<JsonObject>
    ...
    @POST("addPost")
    @FormUrlEncoded
    fun get_addPOSt_withoutevent_Activity_Api(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?,
        @Field("type") type: String,
        @Field("activity_type") activity_type: String,
    ...
    @POST("addPost")
    @FormUrlEncoded
    fun get_addPOSt_withoutevent_age_Activity_Api(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?,
        @Field("type") type: String,
        @Field("activity_type") activity_type: String,
    ...
    @POST("addPost")
    @FormUrlEncoded
    fun get_addPOSt_without_age_Activity_Api(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?,
        @Field("type") type: String,
        @Field("activity_type") activity_type: String,
    ...
    @POST("edit_myadd")
    @FormUrlEncoded
    fun editMyaddActivitywithoutEvent(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?,
        @Field("postId") postId: String,
        @Field("type") type: String,
    ...
    @POST("edit_myadd")
    @FormUrlEncoded
    fun editMyaddActivitywithoutAge(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?,
        @Field("postId") postId: String,
        @Field("type") type: String,
    ...
    @POST("edit_myadd")
    @FormUrlEncoded
    fun editMyaddActivitywithoutAgeEvent(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?,
        @Field("postId") postId: String,
        @Field("type") type: String,
    ...
    @POST("addPost")
    @FormUrlEncoded
    fun getAddTraderPostApiWithoutProduct(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?,
        @Field("type") type: String,
        @Field("trader_type") traderType: String,
    ...
    @POST("addPost")
    @FormUrlEncoded
    fun getAddTraderPostApiWithoutDays(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?,
        @Field("type") type: String,
        @Field("trader_type") traderType: String,
    ...
    @POST("addPost")
    @FormUrlEncoded
    fun getAddTraderPostApiWithoutDaysWithoutProduct(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?,
        @Field("type") type: String,
        @Field("trader_type") traderType: String,
    ...
    @FormUrlEncoded
    @POST("edit_myadd")
    fun editTraderPost_ApiWitoutProductandDay(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?,
        @Field("type") type: String,
        @Field("trader_type") traderType: String,
    ...
    @FormUrlEncoded
    @POST("edit_myadd")
    fun editTraderPost_ApiwithoutDay(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?,
        @Field("type") type: String,
        @Field("trader_type") traderType: String,
    ...
    @FormUrlEncoded
    @POST("edit_myadd")
    fun editTraderPost_ApiWitoutProduct(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") auth_key: String?,
        @Field("type") type: String,
        @Field("trader_type") traderType: String,
    ...
    @FormUrlEncoded
    fun get_SocialCompleteApi_withImage(
        @Header("security_key") securityKey: String?,
        @Field("social_id") social_id: String?,
        @Field("email") email: String?,
        @Field("name") name: String?,
    ...
    @POST("completeprofile_sociallogin")
    @FormUrlEncoded
    fun get_SocialCompleteApi_withoutImage(
        @Header("security_key") securityKey: String?,
        @Field("social_id") social_id: String?,
        @Field("email") email: String?,
        @Field("name") name: String?,
    ...
    @FormUrlEncoded
    fun getGroupMessagesNotification(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") authKey: String?,
    ...
    @FormUrlEncoded
    fun changeGroupMessagesNotification(
        @Header("security_key") securityKey: String?,
        @Header("auth_key") authKey: String?,
        @Field("groupId") groupId: String?,
    ...
    class ForbiddenInterceptor : Interceptor {
        override fun intercept(chain: Interceptor.Chain): Response {
            ...
            if (response.message == "Unauthorized") {
                ...
                val authorization =
                    AllSharedPref.restoreString(AppController.getInstance(), "auth_key")
                ...
                if (!TextUtils.isEmpty(authorization)) {
                    ...
                    Looper.prepare()
                    Toast.makeText(AppController.getInstance(), "Unauthorized", Toast.LENGTH_SHORT)
                        .show()
