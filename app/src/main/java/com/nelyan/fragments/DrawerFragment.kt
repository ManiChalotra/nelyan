...
class DrawerFragment : Fragment() {
   ...
   lateinit var v: View
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        tvAdd!!.setOnClickListener(View.OnClickListener { AppUtils.gotoFragment(mContext, com.nelyan.fragments.MyAddFragment(), R.id.frame_container, false) })
        tvFavorite = v!!.findViewById(R.id.tvFavorite)
        tvFavorite!!.setOnClickListener(View.OnClickListener { AppUtils.gotoFragment(mContext, com.nelyan.fragments.FavoriteFragment(), R.id.frame_container, false) })
