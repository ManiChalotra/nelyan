...
sealed  class ModelPOJO {
    ...
    data class AddEventDataModel( var image:String?, var name:String?,  var dateFrom:String?, var dateTo:String?, var timeFrom:String?, var timeTo:String, var description:String?, var price :String?)
