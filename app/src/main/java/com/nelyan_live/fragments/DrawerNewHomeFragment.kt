...
class DrawerNewHomeFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        requireActivity()!!.supportFragmentManager.beginTransaction().replace(R.id.container, com.nelyan_live.fragments.HomeFragment()).commit()
        ...
        navigation!!.setNavigationItemSelectedListener(NavigationView.OnNavigationItemSelectedListener { item ->
            ...
            when (id) {
                R.id.nav_home ->                         //drawerLayout.closeDrawer(GravityCompat.START);
                    ...
                    changeFragment(com.nelyan_live.fragments.HomeFragment())
                R.id.add -> {
                    changeFragment(com.nelyan_live.fragments.MyAddFragment())
