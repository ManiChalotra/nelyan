    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navigation!!.setNavigationItemSelectedListener(NavigationView.OnNavigationItemSelectedListener { item ->
            ...
            when (id) {
                ...
                R.id.settings -> startActivity(Intent(this@DrawerActivity, com.nelyan_live.ui.SettingsActivity::class.java))
                R.id.logout -> {
                    builder!!.setMessage("Are you sure you want to logout?")
                            .setCancelable(false)
                            .setPositiveButton("Yes") { dialog, id ->
                                startActivity(Intent(this@DrawerActivity, com.nelyan_live.ui.LoginActivity::class.java))
                                finishAffinity()
                            }
