...
class TraderFilterActivity : AppCompatActivity(), View.OnClickListener,AdapterView.OnItemSelectedListener, CoroutineScope
{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        trader_type!!.setOnItemSelectedListener(this@TraderFilterActivity)
        ...
        spinner_trader_distance!!.setAdapter(adapter1)
        spinner_trader_distance!!.setOnItemSelectedListener(this@TraderFilterActivity)
    ...
    private fun hitFilterTrader_Api() {
        if (checkIfHasNetwork(this@TraderFilterActivity)) {
            launch(Dispatchers.Main.immediate) {
                ...
                appViewModel.sendFilterTraderListData(security_key, authKey, latitudee, longitudee, distance!!, et_name.text.toString().trim(),
