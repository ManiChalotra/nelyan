...
class ActivityTypeDialogboxAdapter(var editTraderActivity: EditActivity, var modelTypes: MutableList<ActivityTypeResponse.Data>?, var onclicklistener: onClickListener) :
        RecyclerView.Adapter<ActivityTypeDialogboxAdapter.MyViewHolder>() {
